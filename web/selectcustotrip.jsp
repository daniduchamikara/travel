                            ...
                            <div class="col-lg-12">
                                <section class="panel">
                                    ...
                                    <sql:query dataSource="${dbsource}" var="result">
                                        ...
                                        <form action="tripselectcus.jsp">
                                    <input style="width: 200px;" name="mobile" type="text" class="form-control" placeholder="Enter Telephone No">
                                    <input value="Search" type="submit" class=" btn btn-primary"><br>
                                </form>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="http://localhost:8080/App2.2/updateidcustomer?id=<c:out value="${row.customerId}"/>">Update</a></td>
                                                    <td><a href="http://localhost:8080/App2.2/deleteCustomer?id=<c:out value="${row.customerId}"/>">Delete</a></td>
                                                </c:forEach>
                                            </tr>                                
                                        </tbody>
                                    </table>
