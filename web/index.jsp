<%-- 
    Document   : index
    Created on : 23-Sep-2017, 10:49:08
    Author     : DaniBoy
--%>
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">                
				  ...
				  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a class="" href="http://localhost:8080/App2.2/tripcus">Create Jurney</a></li>                          
                          <li><a class="" href="http://localhost:8080/App2.2/searctripbycus">Create Payment</a></li>
                          <li><a class="" href="http://localhost:8080/App2.2/searctripbycusins">Finish Payments</a></li>
                      </ul>
                  </li>       
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a class="" href="http://localhost:8080/App2.2/addnewhotel">Add Hotel</a></li>
                           <li><a class="" href="http://localhost:8080/App2.2/viewallhotels">View Hotel</a></li>
            ...
            <div class="row">
				...
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					<div class="info-box brown-bg">
						...
						<div class="title">Drivers Available</div>						
					</div><!--/.info-box-->			
				</div><!--/.col-->	
