    ...
    <body>
        ...
        <section id="container" class="">
            ...
            <header class="header dark-bg">
                ...
                <!--logo start-->
                <a href="index.html" class="logo">"${param.tripid}" <span class="lite">Travel</span></a>
                <!--logo end-->
            ...
            <section id="main-content">
                <section class="wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h3 class="page-header"><i class="fa fa fa-bars"></i> Add New Customer</h3>
                            <ol class="breadcrumb">
                                <li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
                                <li><i class="fa fa-square-o"></i>Add New Customer</li>
                            </ol>
                        </div>
                    </div>
                    <div class="panel-body">
                        <form class="form-horizontal " action="finishpayment" method="post">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Kilometers</label>
                                <div class="col-sm-2">
                                    <input name="distance" id="distance" type="text" class="form-control" placeholder="kilometers" onkeyup="sync()">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input  type="number" name="days" id="days" class="form-control" placeholder="Trip Duration" onkeyup="sync()">
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-2 control-label">Amount Of Payment</label>
                                <div class="col-sm-2">
                                    <input type="number" name="amount" id="amount" class="form-control" placeholder="amount">
                                    <input type="hidden" name="tripid"class="form-control" value="${param.tripid}">
                                </div>
                            </div>
        ...
        <script>
            function sync() {
                                            var fn, ln, result;
                                            fn = parseInt(document.getElementById("distance").value, 10);
                                            ln = parseInt(document.getElementById("days").value, 10);
                                            fn = fn * 40;
                                            ln = ln * 700;
                                            result = (fn + ln);
