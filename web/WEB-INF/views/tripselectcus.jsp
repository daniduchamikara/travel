                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <section class="panel">
                                    ...
                                    <div class="panel-body">
                                        <form class="form-inline" role="form" action="http://localhost:8080/App2.2/tripcus">
                                            <div>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="btn-group">
                                                                            <a class="btn btn-success" href="http://localhost:8080/App2.2/selectscope?cusid=<c:out value="${row.customerId}"/>"><i class="icon_check_alt2"></i></a>
                                                                        </div>
                                                                    </td>
                                                                </c:forEach>
                                                            </tr>                                
