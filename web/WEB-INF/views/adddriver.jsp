...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa fa-bars"></i> Add New Driver</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
						<li><i class="fa fa-square-o"></i>Add New Driver</li>
					</ol>
				</div>
			</div>
            <div class="panel-body">
                <form class="form-horizontal " method="post" action="adddriver">
                    ...
                    <label class="col-sm-2 control-label">Driver Name</label>
                        <div class="col-sm-6">
                            <input type="text" name="dname" class="form-control" placeholder="Enter Driver Name">
                        </div>
                    </div>

                    <div class="form-group">
                    <label class="col-sm-2 control-label">Liction No.</label>
                        <div class="col-sm-6">
                            <input type="text" name="licenceno" class="form-control" placeholder="Enter licence Number">
                        </div>
                    </div>

                    <div class="form-group">
                    <label class="col-sm-2 control-label">Liction Catagery</label>
                        <div class="col-sm-6">
                            <input type="text" name="licencecat" class="form-control" placeholder="Enter licence Cattagery">
                        </div>
                    </div>
                    ...
                    <label class="col-sm-2 control-label">Salary </label>  
                        <div class="col-sm-3">
                            <input type="text" name="salary" class="form-control" placeholder="Enter Salary Amount Here">
                        </div>
                    </div>
