...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa fa-bars"></i>Search Vehicles</h3>
					<ol class="breadcrumb">
                ...
                <form class="form-horizontal " method="get">
                    <div class="col-lg-12">
                      <section class="panel">
                          <!--Code Here-->
                          <div class="col-sm-6">
                              <a type="button" class="btn btn-primary btn-lg btn-block" href="VLicensePlateSearch.html">Search By License Plate</a>
                          </div>
                          <div class="col-sm-6">
                              <a type="button" class="btn btn-success btn-lg btn-block" href="VNameSearch.html">Search By Vehicle Name</a>
                          </div>
