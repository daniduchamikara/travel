                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li><i class="fa fa-square-o"></i>View Vehicles</li>
                            </ol>
                        </div>
                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="http://localhost:8080/App2.2/updateiduser?id=<c:out value="${row.userid}"/>">Update</a></td>
                                                    <td><a href="http://localhost:8080/App2.2/deleteusr?id=<c:out value="${row.userid}"/>">Delete</a></td>
                                                </c:forEach>
                                                </td>
                                            </tr>                              
                                        </tbody>
