...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa fa-bars"></i>Search Vehicles By Name</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
						<li><i class="fa fa-bars"></i>vehicles</li>
						<li><i class="fa fa-square-o"></i>serch type</li>
            <li><i class="fa fa-square-o"></i>Vehicle Name Search</li>
					</ol>
				</div>
			</div>
                    ...
                    <div class="col-lg-12">
                      <section class="col-lg-8">
                          ...
                          <div class="col-sm-2">
                           ...
                           <tbody>
                              <tr>
                                 <th><i class="icon_menu-square_alt2"></i> VID</th>
                                 <th><i class=" icon_ol"></i> V Name</th>
                                 <th><i class="icon_id"></i> License Plate</th>
                                 <th><i class="icon_star-half_alt"></i> Type</th>
                                 <th><i class="icon_cogs"></i> Model</th>
                                 <th><i class="icon_genius"></i> AC State</th>
                              </tr>
                              <tr>
