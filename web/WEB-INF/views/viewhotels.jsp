          ...
          <div id="sidebar"  class="nav-collapse ">
            ...
            <section id="main-content">
                <section class="wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h3 class="page-header"><i class="fa fa fa-bars"></i>View Vehicles</h3>
                            <ol class="breadcrumb">
                                <li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
                                <li><i class="fa fa-bars"></i>Pages</li>
                                <li><i class="fa fa-square-o"></i>ViewHotels</li>
                            </ol>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-12">
                                <section class="panel">
                                    ...
                                    <table class="table table-striped table-advance table-hover">
                                        <tbody>
                                            <tr>
                                                <th><i class="icon_profile"></i>Hotel Name</th>
                                                <th><i class="icon_calendar"></i>Address Line 1</th>
                                                <th><i class="icon_mail_alt"></i>Address Line 2</th>
                                                <th><i class="icon_mobile"></i> Address Line 3</th>
                                                <th><i class="icon_pin_alt"></i> phone</th>
                                                <th><i class="icon_pin_alt"></i> Star Rate</th>
                                            ...
                                            <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><c:out value="${row.hName}"/></td>
                                                    <td><c:out value="${row.hAdress1}"/></td>
                                                    <td><c:out value="${row.hAdress2}"/></td>
                                                    <td><c:out value="${row.hAdress3}"/></td>
                                                    <td><c:out value="${row.phone}"/></td>
                                                    <td><c:out value="${row.starRate}"/></td>
                                                    <td><a href="http://localhost:8080/App2.2/updateidhotel?id=<c:out value="${row.hId}"/>">Update</a></td>
                                                    <td><a href="http://localhost:8080/App2.2/deletehotel?id=<c:out value="${row.hId}"/>">Delete</a></td>
                                                </c:forEach>
                                                </td>
                                            </tr>                              
                                        </tbody>
