...
<html lang="en">
  ...
  <section id="container" class="">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a class="" href="AddVehicle.html">Add Vehicle</a></li>
                           ...
                           <li><a class="" href="SearchLocation.html">Search Vehicle</a></li>
                      </ul>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a class="" href="AddHotel.html">Add Hotel</a></li>
                           ...
                           <li><a class="" href="SearchHotel.html">Search Hotel</a></li>
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa fa-bars"></i>Search Hotel</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
            <li><i class="fa fa-square-o"></i>Hotel Search</li>
					</ol>
				</div>
			</div>
                ...
                <form class="form-horizontal " method="get">
                    <div class="col-lg-12">
                      <section class="col-lg-8">
                          ...
                          <br><br>
                              <div class="col-sm-6">
                              <input type="text" class="form-control round-input" placeholder="Enter Hotel Name">
                          </div>
                          <div class="col-sm-2">
                            <a class="btn btn-primary" href="" title="Bootstrap 3 themes generator"><span class="icon_search"></span> Search Hotel</a><br><br>
                          </div>
                          </div>
                          </section>
                           <!--Search bar END-->
                           ...
                           <tbody>
                              <tr>
                                 <th><i class="icon_menu-square_alt2"></i> Hotel Id</th>
                                 <th><i class=" icon_ol"></i> Hotel Name</th>
                                 <th><i class="icon_star-half_alt"></i> Address</th>
                                 <th><i class="icon_cogs"></i> Phone</th>
                                 <th><i class="icon_id"></i> Star Rate</th>
