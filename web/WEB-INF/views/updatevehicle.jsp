    ...
    <body>
        ...
        <section id="container" class="">
            ...
            <header class="header dark-bg">
                ...
                <!--logo start-->
                <a href="index.html" class="logo">"${vid}" <span class="lite">Travel</span></a>
                <!--logo end-->
            ...
            <section id="main-content">
                <section class="wrapper">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal " action="updatevehicle" method="POST">
                            <table id="dataTable" class="table ">
                                <c:forEach var="row" items="${result.rows}">
                                    <tr><td><input type="hidden" value="${vid}" name="vid"/>
                                        <td><h2>Vehicle Name</h2></td>
                                    <input type="text" value="${row.vName}" name="vname"/></td>
                                    </tr>
                                    <tr>
                                        <td><h2>Vehicle Name</h2></td>
                                        <td><input type="text" value="${row.vPlate}" name="regno"/></td>
                                    </tr>
                                    <tr>
                                        <td><h2>Vehicle Type</h2></td>
                                        <td><input type="text" value="${row.vType}" name="vtype"/></td>
                                    </tr>
                                    <tr>
                                        <td><h2>Vehicle Model</h2></td>
                                        <td><input type="text" value="${row.vModel}" name="vmodel"/></td>
                                    </tr>
                                    <tr>
                                        <td><h2>Vehicle AC</h2></td>
                                        <<td><select name="ac">
                                                <option>ac</option>
                                    ...
                                    <tr>
                                        <td><h2>Vehicle Year</h2></td>
                                        <td><input type="text" value="${row.vYear}" name="vyear"/></td>
                                    </tr>
                                    <tr>
                                        <td><h2>Vehicle Charge</h2></td>
                                        <td><input type="text" value="${row.vFee}" name="fee"/></td>
                                    </tr>
                                </c:forEach>
                            </table>
