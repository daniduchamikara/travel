...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa fa-bars"></i> Finish Trip</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
						<li><i class="fa fa-square-o"></i>Finish Trip</li>
					</ol>
				</div>
			</div>
            <div class="panel-body">
                <form class="form-horizontal " action="createCustomer" method="post">
                    ...
                    <label class="col-sm-2 control-label">Kilometers</label>
                        <div class="col-sm-6">
                            <input name="cname" type="text" class="form-control" placeholder="Enter Kilometers">
                        </div>
                    </div>
                    ...
                    <label class="col-sm-2 control-label">Days</label>
                        <div class="col-sm-6">
                            <input type="text" name="passportno" class="form-control" placeholder="Enter Days">
                        </div>
                    </div>
                    ...
                    <label class="col-sm-2 control-label">Country</label>
                        <div class="col-sm-6">
                            <input type="text" name="country" class="form-control" placeholder="Total">
                        </div>
                    </div>
                    ...
                    <label class="col-sm-2 control-label">Discount </label>  
                        <div class="col-sm-3">
                            <input type="text" name="phone" class="form-control" placeholder="Discount">
                        </div>
                    </div>

                    <div class="form-group">
                    <label class="col-sm-2 control-label">Final Payment </label>  
                        <div class="col-sm-3">
