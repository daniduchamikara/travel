                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li><i class="logo"></i>Select Trip To Pay</li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <section class="panel">
                                    ...
                                    <div class="panel-body">
                                        <form class="form-inline" role="form" action="toselecttrip">
                                            <div>
                                            ...
                                            <div class="col-lg-12">
                                                <section class="panel">
                                                    ...
                                                    <sql:query dataSource="${dbsource}" var="result">
                                                        SELECT * from booking where cusId="${param.cusid}";
                                                    </sql:query>
                                                    ...
                                                    <table class="table table-striped table-advance table-hover">
                                                        <tbody>
                                                            <tr>
                                                                <th><i class="icon_profile"></i>Trip Id</th>
                                                                <th><i class="icon_calendar"></i>Check In </th>
                                                                <th><i class="icon_mail_alt"></i>Check Out</th>
                                                                <th><i class="icon_mobile"></i>Trip Title</th>
                                                                <th><i class="icon_mobile"></i>Due Amount</th>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><c:out value="${row.tripid}"/></td>
                                                                    <td><c:out value="${row.checkIn}"/></td>
                                                                    <td><c:out value="${row.checkOut}"/></td>
                                                                    <td><c:out value="${row.heading}"/></td>
                                                                    <td><c:out value="${row.dueAmount}"/></td>
                                                                    <td>
                                                                        <div class="btn-group">
                                                                            <a class="btn btn-success" href="http://localhost:8080/App2.2/instalmentpaying?tripid=<c:out value="${row.tripid}"/>&dueamount=<c:out value="${row.dueAmount}"/>"><i class="icon_check_alt2"></i></a>
                                                                        </div>
                                                                    </td>
                                                                </c:forEach>
                                                            </tr>                                
