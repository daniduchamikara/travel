        ...
        <section id="container" class="">
          ...
          <div id="sidebar"  class="nav-collapse ">
            ...
            <sql:query dataSource="${dbsource}" var="result">
                SELECT * from vehicledriver where driverId=?;
                <sql:param value="${vdid}" />       
            </sql:query>
            ...
            <section id="main-content">
                <section class="wrapper">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal " action="updatedriver" method="POST">
                            <table id="dataTable" class="table ">
                                <c:forEach var="row" items="${result.rows}">
                                    <tr><td><input type="hidden" value="${vdid}" name="driverid"/>
                                        <td><h2>Driver Name</h2></td>
                                    <input type="text" value="${row.dName}" name="dname"/></td>
                                    </tr>
                                    <tr>
                                        <td><h2>Driver License No</h2></td>
                                        <td><input type="text" value="${row.dLicense}" name="licenceno"/></td>
                                    </tr>
                                    <tr>
                                        <td><h2>Driver Licence Cat</h2></td>
                                        <td><input type="text" value="${row.dLicenseCat}" name="licencecat"/></td>
                                    </tr>
                                    <tr>
                                        <td><h2>Driver Phone</h2></td>
                                        <td><input type="text" value="${row.phone}" name="phone"/></td>
                                    </tr>
                                    <tr>
                                        <td><h2>Driver Salary</h2></td>
                                        <td><input type="text" value="${row.salary}" name="salary"/></td>
                                    </tr>
                                </c:forEach>
                            </table>
