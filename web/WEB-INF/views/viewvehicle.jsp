                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li><i class="fa fa-square-o"></i>ViewVehicles</li>
                            </ol>
                        </div>
                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><c:out value="${row.vFee}"/></td>
                                                    <td><a href="http://localhost:8080/App2.2/updateidvehicle?id=<c:out value="${row.vid}"/>">Update</a></td>
                                                    <td><a href="http://localhost:8080/App2.2/deleteVehicle?id=<c:out value="${row.vid}"/>">Delete</a></td>
                                                </c:forEach>
                                                </td>
                                            </tr>                              
                                        </tbody>
