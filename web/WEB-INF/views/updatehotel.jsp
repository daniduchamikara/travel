            ...
            <section id="main-content">
                <section class="wrapper">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal " action="updatehotel" method="POST">
                            <table id="dataTable" class="table ">
                                <c:forEach var="row" items="${result.rows}">
                                    <tr><td><input type="hidden" value="${hid}" name="id"/></td>
                                        <td><h2>Hotel Name</h2></td>
                                    <input type="text" value="${row.hName}" name="name"/></td>
                                    </tr>
                                    <tr>
                                        <td><h2>ADDRESS LINE 1</h2></td>
                                        <td><input type="text" value="${row.hAdress1}" name="address1"/></td>
                                    </tr>
                                    <tr>
                                        <td><h2>ADDRESS LINE 2</h2></td>
                                        <td><input type="text" value="${row.hAdress2}" name="address2"/></td>
                                    </tr>
                                    <tr>
                                        <td><h2>ADDRESS LINE 3</h2></td>
                                        <td><input type="text" value="${row.hAdress3}" name="address3"/></td>
                                    </tr>
                                    <tr>
                                        <td><h2>Hotel Contact No.</h2></td>
                                        <td><input type="text" value="${row.phone}" name="phone"/></td>
                                    </tr>
                                    <tr>
                                        <td><h2>Star Rate</h2></td>
                                        <td><input type="text" value="${row.starRate}" name="srate"/></td>
                                    </tr>
                                </c:forEach>
                            </table>
