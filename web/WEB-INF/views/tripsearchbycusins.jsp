                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <section class="panel">
                                    ...
                                    <div class="panel-body">
                                        <form class="form-inline" role="form" action="http://localhost:8080/App2.2/searctripbycusins">
                                            <div>
                                                <input type="text" name="mobile" class="form form-group">
                                                <input type="submit"  class="btn btn-danger" value="Search" />
                                                <a href="#myModal" data-toggle="modal" class="btn btn-primary">Create Customer</a>
                                            </div>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="btn-group">
                                                                            <a class="btn btn-success" href="http://localhost:8080/App2.2/toselecttripins?cusid=<c:out value="${row.customerId}"/>"><i class="icon_check_alt2"></i></a>
                                                                        </div>
                                                                    </td>
                                                                </c:forEach>
                                                            </tr>                                
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form class="form-horizontal " action="justcreateCustomer" method="post">
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Customer Name</label>
                                                <div class="col-sm-6">
                                                    <input name="cname" type="text" class="form-control" placeholder="Enter Customer Name">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" name="passportno" class="form-control" placeholder="Enter Passport Number">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" name="address" class="form-control" placeholder="Enter Address in short Here">
                                                </div>
                                            </div>
