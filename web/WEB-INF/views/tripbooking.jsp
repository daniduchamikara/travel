...
<html lang="en">
  ...
  <section id="container" class="">
              ...
              <ul class="sidebar-menu">                
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a class="" href="http://localhost:8080/App2.2/viewallcustomers">View Customer</a></li>
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa fa-bars"></i> book trip</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
						<li><i class="fa fa-square-o"></i>Booking Trip</li>
					</ol>
				</div>
			</div>
            <div class="panel-body">
                <form class="form-horizontal " action="finshbooking" method="post">
                    <div class="form-group">
                    <label class="col-sm-2 control-label">Customer Name</label>
                        <div class="col-sm-6">
                            <input name="cname" type="text" value="Daniel Chris" class="form-control">
                        </div>
                    </div>
                    ...
                    <label class="col-sm-2 control-label">From</label>
                        <div class="col-sm-6">
                            <input type="text" name="passportno" class="form-control" placeholder="Date Picker">
                        </div>
                    </div>
                    ...
                    <label class="col-sm-2 control-label">To</label>
                        <div class="col-sm-6">
                            <input type="text" name="country" class="form-control" placeholder="Date Picker">
                        </div>
                    </div>
                    ...
                    <label class="col-sm-2 control-label">Driver</label>  
                        <div class="col-sm-3">
                            <input type="text" name="phone" class="form-control" placeholder="Search Combo">
                        </div>
                    </div>
                    ...
                    <label class="col-sm-2 control-label">Vehicle</label>  
                        <div class="col-sm-3">
                            <input type="text" name="address" class="form-control" placeholder="Search Combo">
                        </div>
                    </div>

                    <div class="form-group">
                    <label class="col-sm-2 control-label">Need To Pay Now</label>  
                        <div class="col-sm-3">
                            <input type="text" name="email" class="form-control" value="10000">
                        </div>
                    </div>
