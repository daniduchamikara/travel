                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="http://localhost:8080/App2.2/updateiddriver?id=<c:out value="${row.driverId}"/>">Update</a></td>
                                                    <td><a href="http://localhost:8080/App2.2/deleteVehicle?id=<c:out value="${row.driverId}"/>">Delete</a></td>
                                                </c:forEach>
                                                </td>
                                            </tr>                              
                                        </tbody>
